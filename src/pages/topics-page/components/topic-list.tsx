...
export default function TopicList() {
  ...
  // Funcția care redirecționează spre pagina de detalii a topicului
  const handleCardClick = (id: number) => (event: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
    navigate(`/topic-details/${id}`);
  };
